...
import com.ecommerce.service.impl.EmailValidator;
import com.ecommerce.service.impl.PasswordValidator;
...
public class ValidatorTest {
    ...
    public void testValidPasswords() {
        Assertions.assertTrue(PasswordValidator.isValidPassword("Password1@"));
